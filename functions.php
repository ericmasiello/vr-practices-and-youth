...
/**
 * Begin Eric's custom carousel shortcode
 */

 function syn_carousel_item( $atts, $content = NULL ) {
 ...
 add_shortcode( "carousel", "syn_carousel" );


function syn_carousel( $atts, $content = NULL ) {
	//extract( shortcode_atts( array( 'section_title' => '', 'gallery_id' => '' ), $atts ) );
	$output = '<section class="carousel-container">';
	$output = '<div class="carousel" id="carousel" aria-live="polite">';
	$output .= '<ul class="carousel-content">';
	$output .= do_shortcode( $content );
	$output .= '</ul>';
	$output .= '</div>';
	$output .= '<fieldset aria-label="carousel buttons" class="carousel-buttons" aria-controls="carousel">';
    $output .= '<button value="pause" id="pause" aria-label="pause" class="carousel-button">||</button>';
    $output .= '<button value="go" id="go" class="carousel-button">play</button>';
    $output .= '<button value="prev" aria-label="previous" id="prev" class="carousel-button">&lt;&lt;</button>';
    $output .= '<button value="next" id="next" aria-label="next" class="carousel-button">&gt;&gt;</button>';
    $output .= '</fieldset>';
    $output .= '</section>';
...
add_shortcode( "carousel", "syn_carousel" );
add_shortcode( "carousel_item", "syn_carousel_item" );
